# Operator Quickstart — cloud-itonami-isic-7820

Shortest path from clone to a verified local dry-run for **ISIC 7820** (`cloud-itonami-isic-7820`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7820.git
